...
# Espera a que Eureka responda en su actuator
...
##############################
# 4. Servicio Person (depende de varios anteriores)
##############################
...
##############################
# 5. Servicio Apollo Federation (depende de person-sv)
##############################
...
##############################
# 6. Servicio API Gateway (depende de apollo-federation)
##############################
